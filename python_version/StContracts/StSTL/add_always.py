# Auto-translated from ./StContracts/StSTL/add_always.m

def add_always(str,formu_index,sat_time_hint,neg_prefix):
...
if comma_num == 0  or  comma_num == 1
    error('add_always() needs its formula string to have three parameters!')
# end
...
if 1 == StSTL.display
    fprintf(StSTL.fid, ['In add_always()',...
