# Auto-translated from ./StContracts/MODEL_and_AP/GaussLin/AP_to_neces_MIP_GaussLin.m

def AP_to_neces_MIP_GaussLin(AP_tag,k,formu_index,neg_prefix):
...
if neg_prefix == 1
    ...
    if AP.p{cons_index} <= 0
        ...
        return
    elseif AP.p{cons_index} > 0  and  AP.p{cons_index} < 1
