# Auto-translated from ./EPS/MODEL_and_AP/AP_to_neces_MIP_EPS.m

def AP_to_neces_MIP_EPS(AP_tag,k,formu_index,neg_prefix):
    # TODO: define outputs: add_result
# AP_TO_NECES_MIP_EPS Translate an atomic proposition (AP) into necessary MILP
...
# end
if cons_index < 0  or  cons_index > AP.N
...
for t = (StSTL.unrolled + 1):1:k # t is the 'real' time, like k
    if t == 0  and  contract_checking == 1
...
# end
elseif p0 == 1 
    if norm(a0) > 0  and  k != 0 # chance cons for x_k, k != 0
