# Auto-translated from ./EPS/StSTL/add_weak.m

def add_weak(str,formu_index,sat_time_hint,neg_prefix):
...
if is_found  and  1 == StSTL.display
    fprintf(['In add_weak(), formula ',StSTL.formu_str{index_1},...
...
if is_found  and  1 == StSTL.display
    fprintf(['In add_weak(), formula ',StSTL.formu_str{index_2},...
