# Auto-translated from ./EPS/StSTL/add_or.m

def add_or(str,formu_index,sat_time_hint,neg_prefix):
...
if given_sub_num > 1  and  given_satis_num > 1  and  given_satis_num != given_sub_num
...
for i = 1:sub_num
    ...
    if is_found  and  1 == StSTL.display
        fprintf(['In add_or(), formula ',StSTL.formu_str{index},...
