# Auto-translated from ./EPS/StSTL/add_until.m

def add_until(str,formu_index,sat_time_hint,neg_prefix):
...
if comma_num == 3
    f1 = str(1:(comma_index(1) - 1))
    f2 = str((comma_index(1) + 1):(comma_index(2) - 1))
...
if is_found  and  1 == StSTL.display
    fprintf(['In add_until(), formula ',StSTL.formu_str{index_1},...
...
# end
    ...
    if is_found  and  1 == StSTL.display
        fprintf(['In add_until(), formula ',StSTL.formu_str{index_i},...
